========================================================================
    KONSOLENANWENDUNG: BoardGameEngine-Projektübersicht
========================================================================

Diese BoardGameEngine-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre BoardGameEngine-Anwendung besteht.


BoardGameEngine.vcxproj
...
BoardGameEngine.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen BoardGameEngine.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
